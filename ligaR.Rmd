...
some of the variables are slightly correlated (however it depends on the threshold we choose to subset or accept a particular variable, based on correlation value.) We would as of now, retain all the variables, except for `B365A` or `B365D` as their correlation is close to $0.85$, also shown in scatter plot matrix. We decide to keep `B365A`, for away win odds.
